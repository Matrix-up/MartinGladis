...
<html lang="pl">
    <head>
        ...
        <title>Pod Wielkim Dębem &nbsp; | &nbsp; Menu</title>
    </head>
    <body>
    <?php
            session_start();
        ...
        <div id="site">
            ...
            <div class="left">
                ...
                <a class="link" id="this" href="menu.php">Menu</a>
                <?php 
                    if ($_SESSION['logged']) {
                ?>
            ...
            <div class="right">
                <table class="menu">
                    <tr>
                        <th class="left-table">NAZWA POTRAWY</th>   <th>CENA</th>
                    </tr>
                    <?php
                        $query = $connect->query("SELECT nazwa, cena FROM potrawy");
                        while ($row = $query->fetch_assoc())
                        {
                            echo "<tr><td class='left-table'>" . $row["nazwa"] . "</td><td>" . $row["cena"] . " zł</td></tr>";
                        }
                    ?>
                </table>
            </div>
